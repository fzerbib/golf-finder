...
const GOLF_DATA = [
  ...
  {
    id: "slug-los-arqueros-golf-country-club",
    ...
    slope: 137,
    courseRating: null,
    greenFee: { low: 70.5, high: 70.5, currency: "EUR" },
    note: "Absent d'OpenStreetMap (trou de couverture confirmé) : coordonnées et localisation approximatives (quartier Los Arqueros, Ctra. de Ronda A-397 Km. 44.5). Par non confirmé.",
    website: "https://www.losarquerosgolf.com/",
    verified: true,
